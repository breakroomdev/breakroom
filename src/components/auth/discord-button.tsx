...
export function DiscordButton({ workspaceSlug, label = "Continue with Discord" }: { workspaceSlug?: string; label?: string }) {
  const href = `/api/auth/discord/start${workspaceSlug ? `?workspace=${encodeURIComponent(workspaceSlug)}` : ""}`;
  return (
