...
export function ReactionBar({
  ...
  async function react(emoji: string) {
    ...
    onUpdated({
      ...
      reactionCount: wasReacted ? Math.max(0, post.reactionCount - 1) : post.reactionCount + 1,
    });
    ...
    try {
      ...
      onUpdated({ reactedByMe: wasReacted, reactionCount: post.reactionCount });
    } finally {
      setPending(false);
    }
  }
        ...
        <PopoverTrigger asChild>
          <button
            ...
            className={cn(
              ...
              post.reactedByMe ? "bg-primary-50 text-primary-700 dark:bg-primary-500/15 dark:text-primary-300" : "text-muted-foreground hover:bg-muted hover:text-foreground"
            )}
          >
            <span>👍</span>
